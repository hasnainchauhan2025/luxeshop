...
export function CheckoutSuccessPage() {
  ...
  // Attempt to get orderId from query string
  const searchParams =
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6 pt-24 pb-16">
      ...
      <div className="w-full max-w-xl text-center">
        ...
        >
          <div className="w-28 h-28 rounded-full glass flex items-center justify-center mx-auto shadow-elevated">
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              transition={{
        ...
        >
          <div className="flex items-start justify-between relative">
            {/* Connector line */}
            <div className="absolute top-5 left-[calc(16.67%+8px)] right-[calc(16.67%+8px)] h-0.5 bg-border" />
            <div
        ...
        >
          A confirmation email will be sent to your inbox. You can track your
          order status from your account page.
        </motion.p>
